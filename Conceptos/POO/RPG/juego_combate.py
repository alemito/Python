...
class Mago(Personaje):
    ...
    def damage(self, enemigo):
        return max(self.inteligencia * self.objeto_magico - enemigo.defensa, 0)
...
def combate(personaje_atacante, personaje_defensor):
    turno = 0
    while personaje_atacante.esta_vivo() and personaje_defensor.esta_vivo():
        print("\nTurno", turno)
...
mi_mago = Mago("Brujo",10, 80, 5, 300)
